...
<body>
  ...
  <div class="breadcumb-area bg-img bg-overlay" style="background-image: url(img\bg-img\te-nguyen-Wt7XT1R6sjU-unsplash.jpg;">
        ...
        <div class="col-12 col-md-6">
          <div class="contact-information">
            <div class="contact-heading mb-50">
              ...
              <p>Want  advice on what song to play on a given occasion? Or are you an upcoming artist struglling to upload your music? Are you  wondering where to start?
              We are available for any enquiries in the field of music.  
              </p>
            </div>


            <h5>Address: Mayor-Road 11-Obed Bulding Rongai-Nairobi-Kenya.</h5>
            <h5>Phone:0791055992</h5>
            <h5>Abbytichi@gmail.com </h5>
