...
<head>
  <meta charset="UTF-8">
  <meta name="description" content="JAS -Music &amp;Audio">
            ...
            <div class="col-12">
              ...
              <div class="poca-music-area mt-100 d-flex align-items-center flex-wrap" data-animation="fadeInUp" data-delay="900ms">
                ...
                <div class="poca-music-content">
                  <span class="music-published-date">july 9, 2021</span>
                  ...
                  <div class="poca-music-player">
                    <audio preload="auto" controls>
                      <source src="audio\Anuel AA, Daddy Yankee, Karol G, Ozuna & J Balvin - China (Video Oficial).mp3">
                    </audio>
                  </div>
          ...
          <div class="row h-100 align-items-center">
            <div class="col-12">
              ...
              <div class="poca-music-area mt-100 d-flex align-items-center flex-wrap" data-animation="fadeInUp" data-delay="900ms">
                ...
                <div class="poca-music-content">
                  <span class="music-published-date">july 8, 2021</span>
                  ...
                  <div class="poca-music-player">
                    <audio preload="auto" controls>
                      <source src="audio\Anne-Marie - 2002 [Official Video].mp3">
                    </audio>
                  </div>
                  <!-- Likes, Share & Download -->
                  <div class="likes-share-download d-flex align-items-center justify-content-between">
          ...
          <div class="row h-100 align-items-center">
            <div class="col-12">
              ...
              <div class="poca-music-area mt-100 d-flex align-items-center flex-wrap" data-animation="fadeInUp" data-delay="900ms">
                ...
                <div class="poca-music-content">
                  <span class="music-published-date">july 7, 2021</span>
                  ...
                  <div class="poca-music-player">
                    <audio preload="auto" controls>
                      <source src="audio/Amos-and-Josh-Baadaye-ft-Rabbit-King-Kaka-Official-Video_wmel7VQaFs4.mp3">
                    </audio>
                  </div>
                  <!-- Likes, Share & Download -->
                  <div class="likes-share-download d-flex align-items-center justify-content-between">
    ...
    <div class="container">
      <div class="row poca-portfolio">
        ...
        <div class="col-12 col-md-6 single_gallery_item entre wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
            ...
            <div class="poca-music-content text-center">
              <span class="music-published-date mb-2">july 9, 2021</span>
              ...
              <div class="poca-music-player">
                <audio preload="auto" controls>
                  <source src="audio\_Cardi B, Bad Bunny & J Balvin - I Like It [Official Music Video].mp3">
                </audio>
              </div>
              <!-- Likes, Share & Download -->
              <div class="likes-share-download d-flex align-items-center justify-content-between">
        ...
        <div class="col-12 col-md-6 single_gallery_item entre tutor wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
            ...
            <div class="poca-music-content text-center">
              ...
              <div class="poca-music-player">
                <audio preload="auto" controls>
                  <source src="audio/Alexandra Stan feat. Mohombi - Balans (Official Music Video).mp3">
                </audio>
              </div>
              <!-- Likes, Share & Download -->
              <div class="likes-share-download d-flex align-items-center justify-content-between">
        ...
        <div class="col-12 col-md-6 single_gallery_item media wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
            ...
            <div class="poca-music-content text-center">
              ...
              <div class="poca-music-player">
                <audio preload="auto" controls>
                  <source src="audio\alan_walker_the_spectre_mp3_7260.mp3">
                </audio>
              </div>
              <!-- Likes, Share & Download -->
              <div class="likes-share-download d-flex align-items-center justify-content-between">
        ...
        <div class="col-12 col-md-6 single_gallery_item tech wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
            <div class="poca-music-thumbnail">
              <img src="img\bg-img\minh-pham-RsmOYMxmlYU-unsplash.jpg"  width="600" alt="">
            </div>
            <div class="poca-music-content text-center">
              <span class="music-published-date mb-2">july 9, 2020</span>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="single-footer-widget mb-80">
            ...
            <div class="single-latest-episodes">
              <p class="episodes-date">july 9, 2021</p>
              <a href="#" class="episodes-title">Episode 205 - See Ya In Three!</a>
            </div>
            <!-- Single Latest Episodes -->
            <div class="single-latest-episodes">
              <p class="episodes-date">july 8, 2021      
