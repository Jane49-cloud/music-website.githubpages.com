        ...
        <div class="col-12 col-lg-8">
          ...
          <div class="poca-music-area style-2 bg-transparent mb-0">
            <div class="poca-music-content text-center">
              ...
              <h2 class="text-white"JAS 3 - You Don’t Know Squat!</h2>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="single-footer-widget mb-80">
            ...
            <!-- Single Latest es -->
            <div class="single-latest-es">
              <p class="es-date">july 9, 2021</p>
              <a href="#" class="episodes-title">JAS 1 - See Ya In Three!</a>
            </div>
            <!-- Single Latest es -->
            <div class="single-latest-es">
              <p class="episodes-date">july 8, 2021</p>
              <a href="#" class="episodes-title"JAS 2 - See Ya In Two!</a>
            </div>
          </div>
        </div>
